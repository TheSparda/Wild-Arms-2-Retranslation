...
Usage:
  python3 tools/prefer_lit_re.py --dry            # report only, change nothing
  python3 tools/prefer_lit_re.py                  # apply in place to all translation/insert/*_FINAL.txt
  python3 tools/prefer_lit_re.py translation/insert/x_FINAL.txt [more...]   # specific files
"""
...
def main():
    ...
    dry='--dry' in sys.argv
    files=args if args else sorted(glob.glob('translation/insert/*_FINAL.txt'))
