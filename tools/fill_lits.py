...
dump a file's remaining clean-JP boxes (LIT still __LIT_TODO__) as JP/EN pairs to translate.
  ...
  dump:  python3 tools/fill_lits.py dump translation/insert/firstpass/blk12_DZ_CC.txt
  patch: python3 tools/fill_lits.py patch translation/insert/firstpass/blk12_DZ_CC.txt /tmp/lits_blk12.py
