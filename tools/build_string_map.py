...
ft=json.load(open("games/Wild Arms 2/data/filetables/filetable_cd1.json"))
...
json.dump(kept, open("games/Wild Arms 2/data/WA2_string_map.json","w"), ensure_ascii=False, indent=0)
