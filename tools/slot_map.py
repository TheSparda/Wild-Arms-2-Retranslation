...
Method (EN<->LIT English matching — possible now that translations exist):
  1. Collect this block's translated boxes from translation/insert/*FINAL*.txt / *PROPAGATED.txt:
...
Output: translation/insert/slot_map_blk<N>.json
...
Usage: python3 tools/slot_map.py <block> [--window 12] [--min-score 0.34]
"""
...
if __name__ == '__main__':
    ...
    out = os.path.join(ROOT, 'translation/insert', f'slot_map_blk{blk}.json')
