...
USAGE
  python3 tools/extract_boxes.py --block 24        # show aligned EN|JP for one block
  python3 tools/extract_boxes.py --dump            # write data/script/boxes.json (all blocks)
  python3 tools/extract_boxes.py --verify          # spot-check known Brad's-Intro lines
"""
...
OUT  = os.path.join(ROOT, 'data/script', 'boxes.json')
