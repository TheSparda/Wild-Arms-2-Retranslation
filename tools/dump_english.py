...
ft1=json.load(open("games/Wild Arms 2/data/filetables/filetable_cd1.json"))
ft2=json.load(open("games/Wild Arms 2/data/filetables/filetable_cd2.json"))
...
print("=== DISC 1 ===")
t1=dump_disc(D1,ft1,"Disc1","games/Wild Arms 2/translation/dumps_en/disc1")
print("=== DISC 2 ===")
t2=dump_disc(D2,ft2,"Disc2","games/Wild Arms 2/translation/dumps_en/disc2")
