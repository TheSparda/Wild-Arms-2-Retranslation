...
added once we insert real edits (and we re-verify against an emulator).
  ...
  extract:  python3 tools/wa2_iso.py extract <bin> <lba> <size> <out.bin>
  reinsert: python3 tools/wa2_iso.py reinsert <bin> <lba> <size> <data.bin> <out_bin>
  verify:   python3 tools/wa2_iso.py verify <bin_a> <bin_b>
"""
