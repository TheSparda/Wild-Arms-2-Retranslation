...
rebuild the DB.
  ...
  python3 tools/kanji_batch_solve.py <block> [limit]   # ranked worklist for one block
  python3 tools/kanji_batch_solve.py apply <block> <code_hex> <kanji>
  python3 tools/kanji_batch_solve.py top [n]            # blocks ranked by solvable-evidence
"""
...
DB_PATH = os.path.join(ROOT, 'data/script', 'wa2_db.json')
UBLK = 90112
BOUND = 0x8a38
