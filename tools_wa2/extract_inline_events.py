...
OUTPUT
  game_script/inline_events.json  — [{off, block, en, indexed(bool), new(bool)}]
...
OUT  = os.path.join(ROOT, 'game_script', 'inline_events.json')
DB   = os.path.join(ROOT, 'game_script', 'wa2_db.json')
