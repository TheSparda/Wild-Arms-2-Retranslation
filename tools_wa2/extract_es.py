...
USAGE
  python3 tools_wa2/extract_es.py --block 3     # EN | ES side by side for one block
  python3 tools_wa2/extract_es.py --dump        # write game_script/es_boxes.json
  python3 tools_wa2/extract_es.py --fit         # measured box-length budget (the useful bit)
  python3 tools_wa2/extract_es.py --audit       # boxes where EN/ES disagree = suspect segmentation
"""
import os, sys, json
...
OUT    = os.path.join(ROOT, 'game_script', 'es_boxes.json')
NBLK   = 120
