...
Run: python3 tools_wa2/add_lit_slots.py            # report only
     python3 tools_wa2/add_lit_slots.py --write     # apply
"""
import os, re, sys, glob

ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
FILES = [os.path.join(ROOT,'insert','m1_chateau_hub_FINAL.txt')] + \
        sorted(glob.glob(os.path.join(ROOT,'insert','firstpass','*.txt')))
